...
// /*   Updated: 2024/12/05 16:49:16 by sepun            ###   ########.fr       */
// /*                                                                            */
// /* ************************************************************************** */
...
// int parce_map(char **data)
// {
// 	printf("Ingrese a parce_map\n");
// 	if (ft_check_char(data) == -1)
// 	{
// 		ft_printf("Error en check char\n");
// 		return (-1);
// 	}
// 	if (ft_check_long_map(data) == -1)
// 	{
// 		// ft_printf("No es un mapa valido\n");
// 		return (-1);
// 	}
// 	if (ft_check_border(data) == -1)
// 	{
// 		// ft_printf("No es un mapa valido\n");
// 		return (-1);
// 	}
